...
public class Player
{
    ...
    public void AddCard()
    {
        ...
        passiveHand1.cards[1] = new Card(11, Card.Suit.diamond);
        passiveHand1.cards[2] = new Card(12, Card.Suit.diamond);
        passiveHand1.cards[3] = new Card(13, Card.Suit.diamond);
